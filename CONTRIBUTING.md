...
- Remember to follow the following files before submitting your changes.
  ...
  - [custom.md](https://github.comJaKooLit/OpenSuse-Hyprland/blob/main/.github/ISSUE_TEMPLATE/custom.md) - Use this template to submit a custom issue.
...
If you have any questions, feel free to contact via [GitHub Discussions](https://github.com/JaKooLit/OpenSuse-Hyprland/discussions) or [Through Discord Server](https://discord.gg/V2SJ92vbEN)
