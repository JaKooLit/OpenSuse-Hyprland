...
# Prepare the options for the checklist
options_command+=(
...
echo "Adding Packman Repo..." | tee -a "$LOG"
sleep 1
execute_script "00-add-repo.sh" | tee -a "$LOG"

echo "Installing necessary dependencies..." | tee -a "$LOG"
sleep 1
execute_script "01-dependencies.sh" | tee -a "$LOG"

echo "Installing necessary fonts..." | tee -a "$LOG"
sleep 1
execute_script "fonts.sh" | tee -a "$LOG"
...
sleep 1
execute_script "hyprland ecosystem.sh" | tee -a "$LOG"
#execute_script "cliphist.sh"

sleep 1
execute_script "force-install.sh" | tee -a "$LOG"

sleep 1
execute_script "03-opi-pkgs.sh" | tee -a "$LOG"

sleep 1
execute_script "wallust.sh" | tee -a "$LOG"
